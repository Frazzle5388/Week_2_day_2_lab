...
class TestBus(unittest.TestCase):
    ...
    def test_passenger_paying_fare(self):
        person_1 = Person("Guido van Rossum", 64, 10)
        self.bus.fare(person_1)
        self.assertEqual(2, self.bus.till)
        self.assertEqual(8, person_1.cash)  

    #@unittest.skip("Delete this line to run the test")
    def test_can_pick_up_passenger_from_bus_stop(self):
        person_1 = Person("Guido van Rossum", 64, 10)
        person_2 = Person("Carol Willing", 50, 10)
